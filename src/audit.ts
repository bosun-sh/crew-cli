...
const AUDIT_LOG_NAME = "crew-cli-audit.jsonl";
const AUDIT_ROTATED_PREFIX = "crew-cli-audit-";
 ...
 * writes cannot grow crew-cli-audit.jsonl without bound. Rotated files are plain JSONL and
