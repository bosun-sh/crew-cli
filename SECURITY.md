...
Do not open a public issue. Use GitHub private vulnerability reporting for `bosun-sh/crew-cli`. If that is unavailable, email `team@bosun.sh` with the affected version, impact, reproduction steps, and any proposed mitigation.
